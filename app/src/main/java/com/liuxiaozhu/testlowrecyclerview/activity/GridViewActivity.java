...
//        item点击事件
    ...
    private void setdata() {
        ...
        adapter = new CommonRecyclerAdapter<Test>(this,list,R.layout.item, RecyclerViewStyle.GridView) {
            @Override
        ...
        new RecyclerViewUtils<>(recyclerView, adapter, 2).addItemDecoration(10,R.color.colorAccent);
    }
