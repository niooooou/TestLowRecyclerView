...
public class HGridviewActivity extends AppCompatActivity {
...
//        item点击事件
    ...
    private void setdata() {
        ...
        adapter = new CommonRecyclerAdapter<Test>(this, list, R.layout.item1, RecyclerViewStyle.HorizontalGridView) {
            @Override
        ...
        new RecyclerViewUtils<Test>(recyclerView, adapter, 2).addItemDecoration(2,R.color.colorAccent);
    }
