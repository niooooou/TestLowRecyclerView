...
public class HWaterfullActivity extends AppCompatActivity {
...
//        item点击事件
    ...
    private void setdata() {
        ...
        adapter = new CommonRecyclerAdapter<Test>(this, list, R.layout.item1, RecyclerViewStyle.HorizontalWaterFall) {
            @Override
